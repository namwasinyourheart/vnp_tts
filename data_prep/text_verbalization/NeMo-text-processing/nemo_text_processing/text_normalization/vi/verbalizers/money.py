...
class MoneyFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        separator = pynutil.delete('separator: "') + pynini.closure(NEMO_NOT_QUOTE, 1) + pynutil.delete('"')

        sep_spoken = pynini.cross(",", NEMO_COMMA_VI) | pynini.cross(".", "chấm")
        separator_spoken = separator @ sep_spoken
