...
from nemo_text_processing.text_normalization.vi.verbalizers.alphanumeric import AlphanumericFst
...
from nemo_text_processing.text_normalization.vi.verbalizers.code import CodeFst
...
from nemo_text_processing.text_normalization.vi.verbalizers.vbqppl import VbqpplFst
...
class VerbalizeFst(GraphFst):
    def __init__(self, deterministic: bool = True):
        ...
        code = CodeFst(deterministic=deterministic)
        code_graph = code.fst

        alphanumeric = AlphanumericFst(deterministic=deterministic)
