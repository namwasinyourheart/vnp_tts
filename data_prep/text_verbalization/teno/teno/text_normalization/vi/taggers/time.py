...
class TimeFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        pattern_minute_p = minute + pynini.union(pynutil.delete("p"), pynutil.delete("P"))
        pattern_second_s = second + pynini.union(pynutil.delete("s"), pynutil.delete("S"))
        pattern_minute_p_second_s = (
            minute
            + pynini.union(pynutil.delete("p"), pynutil.delete("P"))
            + insert_space
            + second
            + pynini.union(pynutil.delete("s"), pynutil.delete("S"))
        )
